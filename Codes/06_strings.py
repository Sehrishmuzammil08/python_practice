...
print(len(sentence.split()))  # split by space (default)
# Output: 5
...
print(text[middle])
# Output: h
# (Python has 6 letters - an even length has no single true middle,
# so index len//2 = 3 lands on 'h')
...
initials = name[0] + name[5] + name[13]
print(initials)
# Output: JMS
# (indices: J=0, M=5, S=13 - "John "=0-4, "Michael "=5-12, "Smith"=13-17)
